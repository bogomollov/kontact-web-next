        ...
        <div className="flex flex-col items-center justify-center h-screen">
            <div className="flex flex-col items-center gap-[25px] md:max-w-md">
                <div className="flex flex-col items-center gap-[10px]">
                    <h2>Регистрация</h2>
                    <h5 className="text-neutral-500">Создайте аккаунт, чтобы общаться с коллегами</h5>
                </div>
                <form action={action} className="flex flex-col gap-[20px] w-full">
                    <div className="flex flex-col gap-[10px] w-full">
                        <div className="flex flex-col items-start gap-[8px] w-full">
                            ...
                            <input
                                ...
                                required
                            />
                            {state?.errors?.firstName && <small className="text-rose-500">{state.errors.firstName}</small>}
                        </div>
                        <div className="flex flex-col items-start gap-[8px] w-full">
                            ...
                            <input
                                ...
                                required
                            />
                            {state?.errors?.lastName && <small className="text-rose-500">{state.errors.lastName}</small>}
                        </div>
                        <div className="flex flex-col items-start gap-[8px] w-full">
                            ...
                            <input
                                ...
                                required
                            />
                            {state?.errors?.middleName && <small className="text-rose-500">{state.errors.middleName}</small>}
                        </div>
                        <div className="flex flex-col items-start gap-[8px] w-full">
                        ...
                        <div className="flex flex-col items-start gap-[8px] w-full">
                            ...
                            <input
                                ...
                                required
                            />
                            {state?.errors?.username && <small className="text-rose-500">{state.errors.username}</small>}
                        </div>
                        <div className="flex flex-col items-start gap-[8px] w-full">
                    ...
                    <button type="submit" disabled={pending} className="inline-flex justify-center px-4 py-2 rounded-md text-white bg-blue-500 disabled:bg-blue-500/80 w-full">Создать аккаунт</button>
                </form>
                    ...
                    <div className="flex flex-col items-center gap-[25px] w-full">
                        <div className="flex gap-[15px] w-full">
                            <button className="inline-flex justify-center items-center px-4 py-2 rounded-md border w-full gap-3">
                                <svg viewBox="0 0 24 24" aria-hidden="true" className="h-[20px]">
                        ...
                        <div className="flex gap-2">
                            <p>Уже есть аккаунт?</p><Link href="/login" className="text-blue-500">Войти</Link>
                        </div>
                    </div>
                </div>
            </div>
