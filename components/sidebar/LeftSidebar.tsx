...
type UserWithoutTimetamps = Omit<
  User,
  "middleName" | "department_id" | "position_id" | "updatedAt" | "deletedAt"
>;
type AccountWithoutPassword = Omit<
  Account,
  "email" | "phone" | "password" | "updatedAt" | "deletedAt"
>;
            ...
            <div className="flex flex-col">
              {isChatLoading ? (
                ...
                chats.map((chat) => (
                  ...
                  >
                    <Image
                      src={`/avatars/${chat.members[0].user.id}.png`}
                      width={55}
                      height={55}
                      alt=""
                    />
